...
// 'guides', 'how-to', 'strategy', 'comparisons' have their own specific routes
const EXCLUDED_DIRS = ['platforms', 'reviews', 'pages', 'categories', 'guides', 'how-to', 'strategy', 'comparisons'];
