...
export function Footer() {
  ...
  const links = [
    ['Learn', [['How to Play Bridge', '/how-to-play-bridge-online/'], ['Bidding Basics', '/bidding-basics/'], ['Card Play Strategy', '/card-play-strategy/'], ['Rules & Laws', '/rules/']]],
    ['Practice & Reviews', [['Practice Boards', '/practice-boards/'], ['Bidding Quiz', '/bidding-quiz/'], ['All Platform Reviews', '/reviews/'], ['Bridge Base Online', '/reviews/bridge-base-online-bbo-review/'], ['Funbridge', '/reviews/funbridge-review/']]],
