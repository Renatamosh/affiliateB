...
export default function BBOClient({ data }) {
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0,2fr) minmax(0,1fr)', gap: 32, alignItems: 'start' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 20, position: 'sticky', top: 88 }}>
              ...
              <div style={{ background: cardBg, border: `1px solid ${bdr}`, borderRadius: 14, padding: 24 }}>
                ...
                {[['Price', data.price], ['Best for', data.bestFor || 'Live human play and ACBL masterpoints'], ['Last verified', data.lastVerified || 'May 2026']].map(([k, v]) => (
              ...
              <div style={{ background: cardBg, border: `1px solid ${bdr}`, borderRadius: 14, padding: 24 }}>
                ...
                <Link href="/reviews/realbridge-review/" style={{ display: 'block', padding: '10px 0', borderBottom: `1px solid ${bdr}`, fontFamily: "'Source Sans 3', sans-serif", fontSize: 15, color: gold, textDecoration: 'none' }}>RealBridge Review →</Link>
