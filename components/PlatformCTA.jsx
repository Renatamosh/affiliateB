...
// The disclosure text and link rel attributes update site-wide automatically.
const PLATFORMS = {
  bbo: {
    ...
    <div style={{
      ...
      {secondary && secondaryHref && (
        <div style={{ marginTop: 16 }}>
          <a href={secondaryHref} style={{ color: gold, fontWeight: 700, fontSize: 15, textDecoration: 'none' }}>
            {secondary} →
          </a>
        </div>
      )}
